    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.os === "android") {
                    const isHermesEnabled = yield react_native_utils_1.getAndroidHermesEnabled(this.gradleFile);
                    if (isHermesEnabled) {
                    ...
                    const isHermesEnabled = yield react_native_utils_1.getiOSHermesEnabled(this.podFile);
                    if (isHermesEnabled) {
                        yield react_native_utils_1.runHermesEmitBinaryCommand(this.bundleName, this.updateContentsPath, this.sourcemapOutput, this.extraHermesFlags);
                    }
                }
